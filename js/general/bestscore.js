...
app.Bestscore.get = function() {
    ...
    if( window.localStorage ) {
        ...
        if( window.localStorage.getItem('gluttonmonsters_bestscore') ) {
            return window.localStorage.getItem('gluttonmonsters_bestscore');
        }
        else {
            return 0;
        }
...
app.Bestscore.store = function() {
    ...
    if( window.localStorage ) {
        window.localStorage.setItem('gluttonmonsters_bestscore', app.Match.score);
    }
    else {
